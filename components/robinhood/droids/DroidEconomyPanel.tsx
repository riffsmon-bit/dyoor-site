...
export function DroidEconomyPanel({
  ...
  return (
    <>
      <EconomySection id="rewards" eyebrow="Funded economic loop" title="Rewards">
        ...
        {!config.flags.droidRewardsEnabled ? (
          <div className="mt-4 rounded-xl border border-sky-300/20 bg-sky-300/[0.06] p-4">
            <p className="text-xs font-black uppercase tracking-[0.14em] text-sky-100">Reward engine staged — not enabled</p>
            <p className="mt-2 text-xs font-semibold leading-5 text-white/40">No reward is promised merely for owning a Droid. Claims appear only after a funded epoch is deployed, verified, and enabled.</p>
          </div>
