...
export const dyoorSeason2SeaDropAbi = [
  ...
  },
  {
    ...
    name: "allowedSeaDrop",
    stateMutability: "view",
    inputs: [{ name: "seaDrop", type: "address" }],
    outputs: [{ type: "bool" }],
  },
  {
    type: "function",
    name: "totalSeaDropMinted",
    stateMutability: "view",
    inputs: [],
    outputs: [{ type: "uint256" }],
  },
