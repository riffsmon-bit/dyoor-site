...
function applyMergedTraitCompatibility(attributes, overrideAttributes) {
  ...
  if (overrideTraits.has("Hat") && !isEmptyOverrideTraitValue(hat)) {
    if (isBandannaTraitValue(accessories)) setAttribute(attributes, "Accessories", "None");
    if (isBandannaTraitValue(accessories2)) setAttribute(attributes, "Accessories 2", "None");
  }
