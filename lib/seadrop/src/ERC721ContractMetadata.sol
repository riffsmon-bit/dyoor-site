    ...
    ISeaDropTokenContractMetadata
{
     ...
     */
    function setBaseURI(string calldata newBaseURI) external virtual override {
     ...
     */
    function setProvenanceHash(bytes32 newProvenanceHash) external virtual {
        // Ensure the sender is only the owner or contract itself.
        _onlyOwnerOrSelf();
     ...
     */
    function setRoyaltyInfo(RoyaltyInfo calldata newInfo) external virtual {
        // Ensure the sender is only the owner or contract itself.
        _onlyOwnerOrSelf();
