...
test("World mobile side drawers and atomic trade desk stay streamlined", () => {
  ...
  assert.match(client, /world-channel-context border-b/);
  assert.match(client, /world-channel-title/);
  ...
  assert.match(gate, /The holder clubhouse/);
  assert.match(gate, /Back to DYOOR ↗/);
  ...
  assert.match(client, /world-sidebar hidden border-r lg:block/);
...
test("the whitepaper positions dYOOR World as the holder home and social apps as onboarding", () => {
  ...
  assert.match(gate, /holder-only home/);
  assert.match(gate, /Discord remains our public onboarding path/);
